...
async def submit_registration(
    ...
    year_level: int = Form(...),
    # Address
    street_barangay:   str | None = Form(default=None),
    city_municipality: str | None = Form(default=None),
    ...
    mother_name:       str | None = Form(default=None),
    mother_occupation: str | None = Form(default=None),
    # Family income
    income_source:     str | None = Form(default=None),
    monthly_income:    str | None = Form(default=None),
    ...
    validate_file_bytes(school_id_bytes, school_id.filename or "")
    validate_file_bytes(cor_bytes, cor.filename or "")
