...
class Application(Base):
    ...
    audit_entries = relationship("AuditEntry", back_populates="application")
    appeal = relationship("Appeal", back_populates="application", uselist=False)
    scholar = relationship("Scholar", back_populates="application", uselist=False)
