...
from app.dependencies import get_current_user, require_osfa, require_student
...
async def list_applications(
    ...
    items, total = await application_service.list_applications(db, current_user, page, page_size)
